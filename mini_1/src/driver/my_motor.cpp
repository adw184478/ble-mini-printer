...
void init_motor()
{
    my_gpio_init(PIN_MOTOR_AP,my_output,my_low_level);
    my_gpio_init(PIN_MOTOR_AM,my_output,my_low_level);
    my_gpio_init(PIN_MOTOR_BP,my_output,my_low_level);
    my_gpio_init(PIN_MOTOR_BM,my_output,my_low_level);
